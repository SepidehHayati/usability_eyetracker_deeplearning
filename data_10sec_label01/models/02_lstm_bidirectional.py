...
base_dir = os.path.dirname(os.path.dirname(__file__))  # go to root of the project
results_dir = os.path.join(base_dir, "results", "02_lstm_bidirectional")
...
model = Sequential([
    Bidirectional(LSTM(units=64), input_shape=X.shape[1:]),
