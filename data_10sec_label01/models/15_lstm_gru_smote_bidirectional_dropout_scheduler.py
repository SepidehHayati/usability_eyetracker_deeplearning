...
results_dir = os.path.join(base_dir, "results", "15_lstm_gru_smote_bidirectional_dropout_scheduler")
...
plt.title("SMOTE + Bidirectional GRU + Dropout + Focal Loss + LR Scheduler")
plt.tight_layout()
