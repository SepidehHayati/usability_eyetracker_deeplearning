...
X = np.load(os.path.join(data_dir, "X8.npy"))   # (108, 1500, 8)
Y = np.load(os.path.join(data_dir, "Y8.npy"))   # (108,)
...
# مسیر ذخیره نتایج
# -------------------------
result_dir = os.path.join("..", "results", "03_cnn_class_weight_balanced_8feats")
