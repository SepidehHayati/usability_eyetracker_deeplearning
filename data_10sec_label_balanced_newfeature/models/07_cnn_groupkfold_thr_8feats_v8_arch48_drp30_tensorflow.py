# 06_cnn_groupkfold_thr_8feats_v8_arch48_drp30_tensorflow.py
# CNN + StratifiedGroupKFold + per-fold thresholding + Top-K snapshot averaging
# Data: X8.npy (N, 1500, 8), Y8.npy (N,), G8.npy (N,)  — 10s gaze deltas, 8 features
...
BATCH_SIZE        = 16
LR_INIT           = 1e-3
MIN_C0_RATIO      = 0.15          # حداقل سهم پیش‌بینی کلاس 0 هنگام جست‌وجوی آستانه
LABEL_SMOOTH      = 0.00
TOPK_CHECKPOINTS  = 5
L2_REG            = 1e-5
