...
RESULT_DIR = os.path.join("..", "results", "14e_cnn_window_ensemble_topk_accopt_tuned_tf_04")
...
# ======================= Config (tuning knobs) =======================
WIN, STR        = 500, 250      # <— پیشنهاد برای افزایش Acc
N_SPLITS        = 6
EPOCHS          = 80
BATCH_SIZE      = 16
LR_INIT         = 1e-3
...
SEEDS           = [7, 17, 23]
TOPK_K          = 5
NEG_BOOST       = 1.6           # 1.2 یا 1.4 را هم تست کن
AGG_MODE        = "median"     # 'mean' یا 'median' یا 'trimmed'
