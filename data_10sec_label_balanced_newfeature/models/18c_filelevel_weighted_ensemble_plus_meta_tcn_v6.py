# 18c_filelevel_weighted_ensemble_plus_meta_tcn_v6.py
# تغییرات: NEG_BOOST=1.7, AGG_MODE="median", GridSearch برای XGBoost, SEEDS بیشتر, ذخیره خطاها, چاپ t_files, اصلاح validation_data
...
RESULT_DIR = os.path.join("..", "results", "18c_filelevel_weighted_ensemble_plus_meta_tcn_v6")
...
THR_STEPS       = 100
SEEDS           = [7, 17, 23, 29, 37]  # افزایش برای پایداری
TOPK_K          = 5
NEG_BOOST       = 1.5  # مقدار میانی برای تعادل
USE_PLATT_CAL   = True
USE_SMOTE       = True
TCN_FILTERS     = 16
TCN_KERNEL_SIZE = 3
...
def fit_seed_ensemble(build_fn, Xtr, Ytr, Xva, Yva, cw, seeds):  # اصلاح Yva
    val_probs, te_probs = [], []
    for seed in seeds:
