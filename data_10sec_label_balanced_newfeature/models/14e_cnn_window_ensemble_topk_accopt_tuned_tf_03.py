# 14e_cnn_window_ensemble_topk_accopt_tuned_tf_01.py
# نسخه‌ی تیون‌پذیر 14d:
# - تنظیم آسان WIN/STR
# - NEG_BOOST برای تقویت کلاس 0
# - انتخاب نوع تجمیع فایل‌سطح: mean / median / trimmed-mean(10%)
# - جست‌وجوی آستانه برای بیشینه‌سازی Accuracy
...
RESULT_DIR = os.path.join("..", "results", "14e_cnn_window_ensemble_topk_accopt_tuned_tf_03")
...
# ======================= Config (tuning knobs) =======================
WIN, STR        = 400, 200      # <— پیشنهاد برای افزایش Acc
N_SPLITS        = 6
EPOCHS          = 80
BATCH_SIZE      = 16
LR_INIT         = 1e-3
...
RANDOM_STATE    = 42
VAL_FILE_RATIO  = 0.35
THR_MIN, THR_MAX = 0.40, 0.80   # بازه کمی «سفت‌تر» برای آستانه
THR_STEPS       = 41
SEEDS           = [7, 17, 23]
TOPK_K          = 5
NEG_BOOST       = 1.2           # 1.2 یا 1.4 را هم تست کن
AGG_MODE        = "trimmed"     # 'mean' یا 'median' یا 'trimmed'
...
for tr_idx, te_idx in gkf.split(Xw, Yw, groups=Gw):
    ...
    # تجمیع به سطح فایل (mean/median/trimmed)
