# 16b_transformer_window_accopt_tf_fast.py
# Lite Transformer: faster + a bit more precision-oriented
# Changes vs 16b:
# - D_MODEL=48, N_HEADS=3, N_LAYERS=1, FFN_DIM=96
# - AGG_MODE="median"
# - THR_MIN/MAX = 0.45..0.85
# - NEG_BOOST=1.6
# - Fewer seeds, fewer epochs
...
RESULT_DIR = os.path.join("..", "results", "16b_transformer_window_accopt_tf_fast")
...
# Transformer (lite)
D_MODEL         = 48
N_HEADS         = 3                  # باید مقسوم‌علیه D_MODEL باشد
FFN_DIM         = 96
N_LAYERS        = 1
DROPOUT         = 0.2
