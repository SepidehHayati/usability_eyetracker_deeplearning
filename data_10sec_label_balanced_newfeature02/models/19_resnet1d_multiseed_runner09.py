# models/19_resnet1d_multiseed_runner09.py
import torch
...
if __name__ == "__main__":
    ...
    import runners.R09_runner_multiseed_acc_first as runner  # ← رانر جدید
    ...
    p.add_argument("--seed", type=int, default=42)  # نادیده گرفته می‌شود
    # می‌تونی seeds را از اینجا override کنی، ولی لازم نیست:
