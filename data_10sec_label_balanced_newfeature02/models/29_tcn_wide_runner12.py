# models/29_tcn_wide_runner12.py
# TCN wide پایدار (BatchNorm+ReLU) - آماده برای Runner 12
...
# ===== اجرای مستقیم با دکمه Run (PyCharm) =====
if __name__ == "__main__":
    import os, sys, argparse
    ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
    sys.path.insert(0, ROOT)
    try:
        import runners.R12_runner_accfirst_mixup_ema as runner
    except ModuleNotFoundError:
        from runners.R12_runner_accfirst_mixup_ema import run_with_model_path as _run
