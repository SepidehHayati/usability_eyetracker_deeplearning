...
class BiLSTMClassifier(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(input_size=4, hidden_size=64, batch_first=True, bidirectional=True)
        self.dropout = nn.Dropout(0.5)
        self.fc = nn.Linear(128, 1)  # چون bidirectional خروجی دو برابر می‌شود
...
# ذخیره نتایج
result_dir = os.path.join("..", "results", "07_bilstm_focal_earlystop_pytorch")
