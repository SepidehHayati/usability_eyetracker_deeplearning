...
# مسیر داده‌های 20 ثانیه‌ای
data_dir = os.path.join("..", "data")
X = np.load(os.path.join(data_dir, "X.npy"), allow_pickle=True) # (108, 3000, 4)
...
history = model.fit(X_train, Y_train, epochs=100, batch_size=16, validation_split=0.2, verbose=1, class_weight=class_weight_dict)
